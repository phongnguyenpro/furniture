...
function buiding_menu($parent, $menuData) {
    ...
    if (isset($menuData['parent'][$parent])) {
        ...
        foreach ($menuData['parent'][$parent] as $value) {
            $html.="<li>";
            $html.=" <span> <input class='id_danhmuc' type='radio' name='id_danhmuc'  id='" . $menuData['items'][$value]['productcategory_id'] . "' value='" . $menuData['items'][$value]['productcategory_id'] . "' data-md-icheck>    <label for='" . $menuData['items'][$value]['productcategory_id'] . "'>" . $menuData['items'][$value]['productcategory_name'] . "   </label> </span>";
...
?>
        ...
        <div id='xoa' class="uk-modal">
            <div class="uk-modal-dialog">
                ...
                <div class="uk-margin uk-modal-content"><span id="thongbaoxoa">Bạn có chắc muốn xóa sản phẩm này?</span></div>
                <div class="uk-modal-footer uk-text-right"> 
                    <button class="uk-modal-close md-btn md-btn-flat">Cancel</button>

                    <form class="hidden" id="xoathuoctinh" action="<?= ADMIN_URL ?>administrator247/editthuoctinhsanpham/deletethuoctinhchon" >
            ...
            <div class="md-card-content">
                <div class="uk-grid" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-2 uk-width-large-1-2">
                        <div class="chondanhmuc"><i class="glyphicon glyphicon-list"></i>  <span>Tất cả danh mục</span> </div>
                        <div class="tree danhmucsanpham" >
                            <input name="id_danhmuc" id="-1" checked="checked" class='id_danhmuc' type='radio'  value='-1' data-md-icheck> 
        ...
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">
                    Danh sách sản phẩm <a href="<?= ADMIN_URL ?>product/create"><button class="btn btn-success">ADD PRODUCT</button></a>
                </h3>
            </div>
...
<script src="<?= load_admin_view("product/js/index.js") ?>"></script>
