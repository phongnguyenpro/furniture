    ...
    <div class="uk-modal-dialog">
        ...
        <form id="createthuoctinh" action="<?= ADMIN_URL ?>career/update" class="uk-form" style="text-align: center">
            <fieldset>
                ...
                <div class="uk-form-row ">
                    <button class="uk-button btnlink">Cập nhật</button>
                </div>
            </fieldset>
        </form>
...
<div id='showcreate' class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <form method="POST" id="createthuoctinh" action="<?= ADMIN_URL ?>career/insert" class="uk-form"
...
<div id='xoa' class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <div>
            <div class="uk-margin uk-modal-content">Bạn có chắc? <b style="color: #e90">Cẩn thận</b> Tất cả dữ liệu sản
                phẩm sẽ bị xóa theo.
            </div>
            <div class="uk-modal-footer uk-text-right">
                <button class="uk-modal-close md-btn md-btn-flat">Cancel</button>

                <form class="hidden" id="xoathuoctinh" action="<?= ADMIN_URL ?>career/delete">
                    ...
                    <li data-id="<?= $value['career_id'] ?>">
                        <div class="md-list-content">
                            <div class="uk-grid">
                                ...
                                <a data-id="<?= $value['career_id'] ?>" data-ten="<?= $value['career_name'] ?>"
                                   class="sua">Sửa</a>
                                <a data-id="<?= $value['career_id'] ?>" data-ten="<?= $value['career_name'] ?>"
                                   class="xoa">Xóa</a>
