...
<div id='showedit' class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <form id="createthuoctinh" method="POST" action="<?= ADMIN_URL ?>product_prop/update" class="uk-form"
...
<div id='showcreate' class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <form id="createthuoctinh" method="POST" action="<?= ADMIN_URL ?>product_prop/insert" class="uk-form"
              style="text-align: center">
            <fieldset>
                ...
                <div class="uk-form-row ">
                    <button class="uk-button">TẠO</button>
                </div>
            </fieldset>
        </form>
        <div class="uk-modal-footer"><a href="" class="uk-modal-close uk-close uk-close-alt"></a></div>
...
<div id='xoa' class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <div>
            <div class="uk-margin uk-modal-content">Bạn có chắc?</div>
                            ...
                            <li data-id="<?= $value['product_prop_id'] ?>">
                                ...
                                <div class="md-list-content">
                                    <div class="uk-grid">
                                        ...
                                        <div class="uk-width-1-4"><a data-nganhnghe="<?= $value['career_id'] ?>"
                                                                     data-id="<?= $value['product_prop_id'] ?>"
                                                                     data-ten="<?= $value['product_prop_name'] ?>"
                                                                     class="sua label label-info">Sửa</a></div>
                                        <div class="uk-width-1-4">
                                            <a data-id="<?= $value['product_prop_id'] ?>"
                                               data-ten="<?= $value['product_prop_name'] ?>"
                                               class="xoa label label-danger">Xóa</a>
                                        </div>
