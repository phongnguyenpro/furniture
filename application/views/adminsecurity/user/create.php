...
<!-- FORM THONG TIN -->
<form action="<?= ADMIN_URL ?>user/<?= isset($this->data["is_edit"]) ? "update" : "insert" ?>"  class="uk-form-stacked" name="updateuser" id="form_validation" method="post" enctype="multipart/form-data">
                        ...
                        <div class="uk-width-large-1-2">
                            ...
                            <div class="uk-form-row">
                                <div class="uk-input-group">
                                    ...
                                    <input <?= isset($this->data["is_edit"]) ? "disabled" : "" ?>  type="password"   class="md-input" id="password_confirmation" required="" name="user_password"  value='<?= $this->data['user']["user_password"] ?>'/>
                                </div>
                            </div>
                            <div class="uk-form-row">
                                <div class="uk-input-group">
                                    ...
                                    <input <?= isset($this->data["is_edit"]) ? "disabled" : "" ?>  type="password" data-parsley-equalto="#password_confirmation" required="" class="md-input"  name="user_password"  value='<?= $this->data['user']["user_password"] ?>'/>
                                </div>
                            </div>
                            <?php if (isset($this->data["is_edit"])) { ?>
                                <div class="uk-form-row">
                                    <div class="uk-input-group">
                                        <span class="uk-input-group-addon">
                                            <i class="uk-icon-password"></i>
                                        </span>
                                        <a data-status='0' class="md-btn md-btn-primary btn_changepass">Đổi mật khâu</a>
                                    </div>
                                </div>
                            <?php } ?>
                            <div class="uk-form-row">
                            ...
                            <div class="uk-form-row">
                                <div class="uk-input-group">
                                    ...
                                    <label for="product_edit_name_control">Trạng thái</label><br>
                                    <input name="user_status" <?=  $this->data['user']["user_status"]==1?"checked":"" ?> type="checkbox" data-switchery data-switchery-color="#4e8c4d" id="switch_demo_danger" />
                            ...
                            <div class="uk-form-row">
                                <div class="uk-input-group">
                                    ...
                                    <div class="uk-form-row parsley-row">
                                        ...
                                        <span class="icheck-inline">
                                            <input value="2"  type="radio" name="user_sex" <?= $user["user_sex"] == 2 ? "checked" : "" ?> id="val_radio_female" data-md-icheck />
                            ...
                            <div class="uk-form-row">
                                <div class="uk-input-group">
                                    ...
                                    <div class="md-input-wrapper md-input-filled">
                                        ...
                                        <input class="md-input datetime" type="text" id="uk_dp_1" name="user_birthday" value="<?= date_out($user["user_birthday"]) ?>" data-uk-datepicker="{format:'DD/MM/YYYY',i18n:{ months:['Tháng 1','Tháng 2','Tháng 3','Tháng 4','Tháng 5','Tháng 6','Tháng 7','Tháng 8','Tháng 9','Tháng 10','Tháng 11','Tháng 12'],weekdays:['Chủ nhật','TH2','TH3','TH4','TH5','TH6','TH7']}}"  >
                ...
                <div class="md-card-content">
                    ...
                    <div class="uk-margin-bottom uk-text-center uk-position-relative">
                        <div class="boxanhdaidien">
                            <img class="img-responsive" id="imgavatar" src="<?= BASE_URL . "public/upload/images/user_profile/" . $user["user_avatar"] ?>">
