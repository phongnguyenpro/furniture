                ...
                <div class="homeslider">
                    <div class="content-slide" style="height: 450px;overflow: hidden">
                        <ul id="slide-background" >
                            <?php if (isset($this->data['module']['slider']["main"][1]['data'])) {
                                foreach ($this->data['module']['slider']["main"][1]['data'] as $value) {
                                    ?>
                                    <li data-background="">
...
<div class="content-page">
    <div class="container">
        ...
        $i = 0;
        $quangcao = 0;
        foreach ($this->data['product']['home_productcategory_data'] as $sanpham) {
            ?>
    ...
    $left = 0;
    $item = 5;
    if (isset($this->data['module']['banner']['main'][2]["data"][$quangcao])) {
        ?>
