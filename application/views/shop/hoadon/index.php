...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?= URL . "view/" . THEME ?>/assets/lib/bootstrap/css/bootstrap.min.css"/>
        ...
        <div class="boxtthongtinsanpham">
            <table class="table table-bordered">
                    ...
                    <tr>
                        <td class="cart_product">
                            ...
                            <img width="50" class="img-responsive"
                                 src="<?= URL . "public/upload/images/thumb_hinhsanpham/" . $value['hinhsanpham'] ?>"
                                 alt="p10">

                            <small><?= $value['tensanpham'] ?></small>
                            <br>
                ...
                <tr>
                    ...
                    <td colspan="1"><strong class="tientotal">$<?= tien($tongtien - $thongtin['tonggiamgia']) ?>
                            VND</strong></td>
                </tr>
                </tfoot>
            </table>
            ...
            <div class="col-1">
                ...
                <p><b>Trạng thái hóa đơn:</b><b
                            class="label label-danger"><?= $this->data['tinhtrang'][$thongtin['tinhtrang']] ?> </b></p>
                <p><b>Hình thức thanh toán:</b> <?= $this->data['hinhthucthanhtoan'][$thongtin['hinhthucthanhtoan']] ?>
                </p>
...
<?php if ($thongtin['tinhtrang'] != 3 && $thongtin['hinhthucthanhtoan'] == 3) { ?>
    <div class=" text-center no-print">
        <?php if ($this->data['chophepthanhtoan']) { ?>
            <br>
            <a href="<?= URL ?>hoadon/baokim/createurl/<?= $thongtin['mahoadon'] ?>/<?= $thongtin['mabaove'] ?>"><img
                        src="http://www.baokim.vn/developers/uploads/baokim_btn/thanhtoanantoan-l.png"
            ...
            <div class="huongdanthanhtoan" style="width: 500px;margin: auto">
                ...
                <ol class="text-left">
                    ...
                    <li>Khi thanh toán thành công. Hóa đơn của bạn sẽ chuyển sang trạng thái <b>đã thanh toán</b> và
                        xuất hiện <b>mã giao dịch</b>.
                    </li>
                    <li><b style="color: red">Bạn lưu lại mã giao dịch để giải quyết những khiếu nại phát sinh nếu có
                            giữa 2 bên.</b></li>
                </ol>
            </div>
            <br>
